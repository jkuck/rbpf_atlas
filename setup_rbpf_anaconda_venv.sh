...
python rbpf_KITTI_det_scores.py $num_particles $include_ignored_gt $include_dontcare_in_gt $use_regionlets $det1_name $det2_name $sort_dets_on_intervals $RUN_IDX $NUM_RUNS $SEQ_IDX
