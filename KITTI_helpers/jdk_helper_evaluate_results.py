...
if __name__ == "__main__":
    ...
    if use_corrected_eval:
        ...
        eval_results(results_dir + "/results_by_run", seq_idx_to_eval=[i for i in range(21)], use_corrected_eval=use_corrected_eval) # + operateor used for string concatenation!
        sys.stdout.close()
        sys.stdout = stdout
